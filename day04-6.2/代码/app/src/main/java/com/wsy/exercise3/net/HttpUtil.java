...
import com.wsy.exercise3.util.SpUtil;
import com.wsy.exercise3.util.SystemUtil;
...
//单例-》双重校验
    ...
    /**
     * 请求的修改设置
     * 在上面日志拦截器写：.addInterceptor(new HeadersInterceptor())
     */
    ...
    private class MyCacheinterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            //这里就是说判断我们的网络条件，要是有网络的话我么就直接获取网络上
    ...
    public class LoggingInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            //拦截链对象
            Request request = chain.request();//OK请求
